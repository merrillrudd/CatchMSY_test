...
#-----------------------------------------
catch_file  <-  "O_Catch.csv"    #"O_ICES_Catch_10.csv" # name of file containing "stock", "yr", "ct", and optional "bt"
id_file     <-  "O_ID.csv"  #"O_ICES_ID_11.csv"    # name of file containing stock-specific info and settings for the analysis
...
stocks <- c("Sole_sol_AD")     #c("cod-2224") #c("tur-kask")   #c("cod-scow") # c("MULLBAR_BA") #c("CORYHIP_SA")  #   c("Tur_BS")  #  #   "sal-2231"    #c("sol-iris") # c("cod-2224")   
